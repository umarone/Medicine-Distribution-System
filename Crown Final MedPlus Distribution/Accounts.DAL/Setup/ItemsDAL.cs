    ...
    public class ItemsDAL
    {
        ...
        public bool UpdateCurrentStock(List<ItemsEL> list, SqlConnection objConn)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                cmdItems.Parameters.Add(new SqlParameter("@TotalCartons", DbType.Int64)).Value = list[i].TotalCartons;
                cmdItems.Parameters.Add(new SqlParameter("@BatchNo", DbType.String)).Value = list[i].BatchNo;
                cmdItems.Parameters.Add(new SqlParameter("@Mfg", DbType.String)).Value = list[i].Mfg;
                cmdItems.Parameters.Add(new SqlParameter("@Expiry", DbType.String)).Value = list[i].Expiry;
                cmdItems.Parameters.Add(new SqlParameter("@EngineNo", DbType.String)).Value = list[i].EngineNo;
                cmdItems.Parameters.Add(new SqlParameter("@chasisNo", DbType.String)).Value = list[i].ChasisNo;
                cmdItems.Parameters.Add(new SqlParameter("@VehicleNo", DbType.String)).Value = list[i].VehicleNo;
        ...
        public List<ItemsEL> GetItemsCurrentStockByCategory(Int64? IdCategory, Int64 IdProject, SqlConnection objConn)
        {
            ...
            while (oReader.Read())
            {
                ...
                oelItems.BatchNo = Validation.GetSafeString(oReader["BatchNo"]);
                oelItems.Mfg = Validation.GetSafeString(oReader["Mfg"]);
        ...
        public List<ItemsEL> GetItemsCurrentStockById(Int64? IdItem, Int64 IdProject, SqlConnection objConn)
        {
            List<ItemsEL> list = new List<ItemsEL>();
            SqlCommand cmdItem = new SqlCommand("[Setup].[Proc_GetItemsCurrentStockById]", objConn);
        ...
        public decimal GetItemClosingStockByBatchNo(Int64 IdItem, string BatchNo, SqlConnection objConn)
        {
            using (SqlCommand cmdItem = new SqlCommand("[Setup].[Proc_GetItemClosingStockByBatchNo]", objConn))
            {
                cmdItem.CommandType = CommandType.StoredProcedure;
                cmdItem.Parameters.Add("@IdItem", SqlDbType.BigInt).Value = IdItem;
                cmdItem.Parameters.Add("@BatchNo", SqlDbType.VarChar).Value = BatchNo;
                return Validation.GetSafeDecimal(cmdItem.ExecuteScalar());
            }
        }
        ...
        public decimal GetItemsValueBatchWise(Int64 IdItem, string BatchNo, SqlConnection objConn)
        {
            using (SqlCommand cmdItem = new SqlCommand("[Setup].[Proc_GetItemsValueBatchWise]", objConn))
            {
                cmdItem.CommandType = CommandType.StoredProcedure;
                cmdItem.Parameters.Add("@IdItem", SqlDbType.BigInt).Value = IdItem;
                cmdItem.Parameters.Add("@BatchNo", SqlDbType.VarChar).Value = BatchNo;
        ...
        public List<VoucherDetailEL> TrackBatchNo(string BatchNo, SqlConnection objConn)
        {
            List<VoucherDetailEL> list = new List<VoucherDetailEL>();
            SqlCommand cmdItem = new SqlCommand("[Transactions].[Proc_TrackBatchNo]", objConn);
