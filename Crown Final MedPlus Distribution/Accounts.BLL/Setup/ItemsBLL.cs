...
namespace Accounts.BLL
{
    public class ItemsBLL
    {
        ...
        public List<ItemsEL> GetItemsCurrentStockById(Int64? IdItem, Int64 IdProject)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetItemsCurrentStockById(IdItem, IdProject, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public decimal GetItemsValueBatchWise(Int64 IdItem, string BatchNo)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetItemsValueBatchWise(IdItem, BatchNo, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public decimal GetItemClosingStockByBatchNo(Int64 IdItem, string BatchNo)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.GetItemClosingStockByBatchNo(IdItem, BatchNo, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
        ...
        public List<VoucherDetailEL> TrackBatchNo(string BatchNo)
        {
            SqlConnection objConn = new SqlConnection(DBHelper.DataConnection);
            try
            {
                objConn.Open();
                return dal.TrackBatchNo(BatchNo, objConn);
            }
            catch (Exception ex)
            {
                objConn.Close();
