...
namespace Accounts.UI
{
    public partial class frmMain : Form
    {
        ...
        frmTrackBatchNo frmtrackbatchno;
        #region Setup Related Variables
        frmRegions frmallregions;
        #endregion
        ...
        {
            frmallregions = new frmRegions();
            frmallregions.MdiParent = this;
            if (Operations.IdRole == Validation.GetSafeLong(EnRoles.CheifExecutive) || Operations.IdRole == Validation.GetSafeLong(EnRoles.Administrator))
            {
                frmallregions.Show();
            }
            else if (CheckModuleRights(frmallregions.Name) != 0)
            {
                frmallregions.Show();
            }
            else
            {
                frmallregions.Dispose();
                MessageBox.Show("Access Is Denied");
            }
            RibbonAutoclose();
        }       
        ...
        private void colTrackNo_Click(object sender, EventArgs e)
        {
            frmtrackbatchno = new frmTrackBatchNo();
            frmtrackbatchno.MdiParent = this;
            frmtrackbatchno.Show();
        }
        #endregion
