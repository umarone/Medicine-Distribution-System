...
namespace Accounts.UI
{
    public partial class frmSales : MetroForm
    {
            ...
            if (list.Count > 0)
            {
                ...
                if (objActiveType != null)
                {
                    ...
                    {                        
                        ...
                        DgvStockSales.Columns["colItemName"].Width = 250;
                        DgvStockSales.Columns["colpacking"].Width = 60;
                        DgvStockSales.Columns["colBatchNo"].Width = 65;
                        DgvStockSales.Columns["colMfg"].Width = 65;
                        DgvStockSales.Columns["colExpiry"].Width = 65;
                        DgvStockSales.Columns["colpacking"].Width = 65;
                        DgvStockSales.Columns["colCurrentStock"].Width = 65;
                        DgvStockSales.Columns["colQty"].Width = 65;
                        DgvStockSales.Columns["colUnitPrice"].Width = 65;
                        DgvStockSales.Columns["colAmount"].Width = 80;
                        DgvStockSales.Columns["colDiscount"].Width = 80;
                        DgvStockSales.Columns["colDiscountAmount"].Width = 90;
                        DgvStockSales.Columns["colDelete"].Width = 60;
        ...
        private bool ValidateRows()
        {
            ...
            {
                if (DgvStockSales.Rows[i].Cells["colBatchNo"].Value == null)
                {
                    MessageBox.Show("Batch No Is Missing....");
                    return false;
                }
                else if (DgvStockSales.Rows[i].Cells["colQty"].Value == null)
                {
                    MessageBox.Show("Expiry Date Is Compulsory...");
                    return false;
                }
                else if (DgvStockSales.Rows[i].Cells["colQty"].Value == null)
                {
        ...
        private string BuildRemarks()
        {
            ...
            for (int i = 0; i < DgvStockSales.Rows.Count - 1; i++)
            {
                Remarks += DgvStockSales.Rows[i].Cells[3].Value.ToString() + " "
                           ...
                           + " @ " + DgvStockSales.Rows[i].Cells[24].Value.ToString() + "~";
            }
            First += Remarks;
            return First;
        }
                ...
                if (ValidateControls())
                {
                    if (ValidateBookPeriod())
                    {
                        ...
                        for (int i = 0; i < DgvStockSales.Rows.Count - 1; i++)
                        {
                            ...
                            oelSaleDetial.Mfg = Validation.GetSafeString(DgvStockSales.Rows[i].Cells["colMfg"].Value);
                        ...
                        if (chkPosted.Checked)
                        {
                            for (int k = 0; k < DgvStockSales.Rows.Count - 1; k++)
                            {
                                ...
                                if (oelCostOfSalesCollection.Count > 0)
                                {
                                    ...
                                    {
                                        oelCostOfSalesCollection.Add(CreateInventoryTransaction(oelVoucher, EachItem, Validation.GetSafeDecimal(DgvStockSales.Rows[k].Cells["colQty"].Value), Validation.GetSafeString(DgvStockSales.Rows[k].Cells["colBatchNo"].Value)));
                                    }
                                }
                                else
                                {
                                ...
                                if (oelCostOfSalesCollection.Count > 0)
                                {
                                    ...
                                    {
                                        oelCostOfSalesCollection.Add(CreateCOGSTransaction(oelVoucher, EachItem, Validation.GetSafeDecimal(DgvStockSales.Rows[k].Cells["colQty"].Value), Validation.GetSafeString(DgvStockSales.Rows[k].Cells["colBatchNo"].Value)));
                                    }
                                }
                                else
                                {
                        ...
                        if (!IsNetTransaction)
                        {
                            ...
                            if (chkPosted.Checked)
                            {
                                oelCustomerTransaction.PostedDateTime = DateTime.Now;
                            }
                            else
                                oelCustomerTransaction.PostedDateTime = null;
        ...
        private VoucherDetailEL CreateInventoryTransaction(VouchersEL oelVoucher, List<ItemsEL> EachItem, decimal Quantity, string BatchNo)
        {
            ...
            oelInventoryVoucherDetail.Credit = Validation.GetSafeDecimal(manager.GetItemsValueBatchWise(EachItem[0].IdItem.Value, BatchNo)) * Quantity; //EachItem[0].AVGEvaluationUnitPrice);
        ...
        private VoucherDetailEL CreateCOGSTransaction(VouchersEL oelVoucher, List<ItemsEL> EachItem, decimal Quantity, string BatchNo)
        {
            var manager = new ItemsBLL();
            ...
            oelCOGSVoucherDetail.Debit = Validation.GetSafeDecimal(manager.GetItemsValueBatchWise(EachItem[0].IdItem.Value,BatchNo)) * Quantity;//EachItem[0].AVGEvaluationUnitPrice);
        ...
        void frmfindProducts_ExecuteFindPorudctsEvent(object Sender, ItemsEL oelItems)
        {
            ...
            DgvStockSales.CurrentRow.Cells["colBatchNo"].Value = oelItems.BatchNo;
            DgvStockSales.CurrentRow.Cells["colMfg"].Value = oelItems.Mfg;
            DgvStockSales.CurrentRow.Cells["colExpiry"].Value = oelItems.Expiry;
            DgvStockSales.CurrentRow.Cells["colCurrentStock"].Value = oelItems.Qty;
        ...
        void txtItemName_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (DgvStockSales.CurrentCellAddress.X == 3)
            {
                if (e.KeyChar != (char)Keys.Back && e.KeyChar != (char)Keys.Escape)
                {
                    ...
                    frmfindProducts.SearchType = "SaleInvoiceVoucher";
            ...
            if (DgvStockSales.Columns[e.ColumnIndex].Name == "colQty")
            {
                if (DgvStockSales.Rows[e.RowIndex].Cells["colIdItem"].Value != null)
                {
                    ...
                    if (oelSoftwareCheck != null && oelSoftwareCheck.IsMust.Value)
                    {
                        ...
                        decimal ClosingStock = manager.GetItemClosingStockByBatchNo(Validation.GetSafeLong(DgvStockSales.Rows[e.RowIndex].Cells["colIdItem"].Value),Validation.GetSafeString(DgvStockSales.Rows[e.RowIndex].Cells["colBatchNo"].Value));
        ...
        private void FillSales(List<VoucherDetailEL> List)
        {
            ...
            if (List != null && List.Count > 0)
            {
                ...
                for (int i = 0; i < List.Count; i++)
                {
                    ...
                    DgvStockSales.Rows[i].Cells[7].Value = List[i].Mfg;
                    ...
                    DgvStockSales.Rows[i].Cells[21].Value = CommonFunctions.RemoveTrailingZeros(List[i].Discount) + "%";
                    DgvStockSales.Rows[i].Cells[22].Value = List[i].DiscountAmount;
                    DgvStockSales.Rows[i].Cells[23].Value = List[i].LineDiscount;
                    DgvStockSales.Rows[i].Cells[24].Value = List[i].NetSaleAmount;
