...
namespace Accounts.UI
{
    public partial class frmStockReceipt : MetroForm
    {
        ...
        private void frmStockReceipt_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Text = "Inventory / Goods Receipt Note ";
            }
            ...
            if (list.Count > 0)
            {
                ...
                if (objActiveType != null)
                {
                    ...
                    else if (objActiveType.SoftwareType == "Medicine General Trading")
                    {
                        ...
                        DgvStockReceipt.Columns["colItemName"].Width = 220;
                        DgvStockReceipt.Columns["colpacking"].Width = 65;
                        DgvStockReceipt.Columns["colBatchNo"].Width = 75;
                        DgvStockReceipt.Columns["colMfg"].Width = 60;
                        DgvStockReceipt.Columns["colExpiry"].Width = 60;
                        DgvStockReceipt.Columns["colQty"].Width = 65;
                        DgvStockReceipt.Columns["colBonus"].Width = 65;
                        DgvStockReceipt.Columns["colUnitPrice"].Width = 65;
                    }
        ...
        private bool ValidateRows()
        {
            ...
            {
                if (DgvStockReceipt.Rows[i].Cells["colBatchNo"].Value == null)
                {
                    MessageBox.Show("Please Fill Batch No....");
                    return false;
                }
                else if (DgvStockReceipt.Rows[i].Cells["colExpiry"].Value == null)
                {
                    MessageBox.Show("Expiry Date Is Must To Enter....");
                    return false;
                }
                ...
                if (ValidateControls())
                {
                    if (ValidateBookPeriod())
                    {
                        ...
                        for (int i = 0; i < DgvStockReceipt.Rows.Count - 1; i++)
                        {
                            ...
                            oelPurchaseDetial.Mfg = Validation.GetSafeString(DgvStockReceipt.Rows[i].Cells["colMfg"].Value);
        ...
        private void FillPurchases(List<VoucherDetailEL> List)
        {
            ...
            if (List != null && List.Count > 0)
            {
                ...
                for (int i = 0; i < List.Count; i++)
                {
                    ...
                    DgvStockReceipt.Rows[i].Cells[7].Value = List[i].Mfg;
                    ...
                    DgvStockReceipt.Rows[i].Cells[20].Value = CommonFunctions.RemoveTrailingZeros(List[i].Discount) + "%";
