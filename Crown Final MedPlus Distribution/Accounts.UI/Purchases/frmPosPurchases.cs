...
namespace Accounts.UI
{
    public partial class frmPosPurchases : Form
    {
        ...
        private void FillData()
        {
            ...
            txtInvoiceNumber.Text = manager.GetMaxPurchaseNumber(Operations.IdProject, Operations.BookNo, true).ToString();
        }
        ...
        private void FillVoucher()
        {
            ...
            if (ListPurchases.Count > 0)
            {
                ...
                txtInvoiceTotal.Text = ListPurchases[0].BillAmount.ToString();
                txtFreight.Text = ListPurchases[0].TotalFreight.ToString();
                txtDiscount.Text = ListPurchases[0].Discount.ToString();
